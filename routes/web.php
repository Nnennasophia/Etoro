...
Route::get('/explore', [App\Http\Controllers\VisitorController::class, 'explore'])->name('explore');
Route::get('/join', [App\Http\Controllers\VisitorController::class, 'join'])->name('join');
Route::get('/market', [App\Http\Controllers\VisitorController::class, 'market'])->name('market');
...
Route::get('/privacypolicy', [App\Http\Controllers\VisitorController::class, 'terms'])->name('terms');
...
Route::get('/clienteducation', [App\Http\Controllers\VisitorController::class, 'client'])->name('client');
...
Route::get('/ourplan', [App\Http\Controllers\VisitorController::class, 'ourplan'])->name('ourplan');

Route::get('/cryptocurrency', [App\Http\Controllers\VisitorController::class, 'buybtc'])->name('buybtc');
Route::get('/cannabis', [App\Http\Controllers\VisitorController::class, 'cannabis'])->name('cannabis');
Route::get('/cannabistrade', [App\Http\Controllers\VisitorController::class, 'cannabistrade'])->name('cannabistrade');
...
Route::get('/stockinvest', [App\Http\Controllers\VisitorController::class, 'stockinvest'])->name('stockinvest');
Route::get('/forextrade', [App\Http\Controllers\VisitorController::class, 'forextrade'])->name('forextrade');

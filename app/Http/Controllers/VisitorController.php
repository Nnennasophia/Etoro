...
class VisitorController extends Controller
{
   ...
   public $owneremail ="gettingsnano@gmail.com";
    ...
    $company_detail = Sitesetting::where('id', 1)->first();
    $data['compd'] = $company_detail;
    $data['title']="Our Plans";
        return view ("visitors.ourplan", $data);
    }
...
public function cannabistrade()
    {
        # code...
    $data=[];
    $company_detail = Sitesetting::where('id', 1)->first();
    $data['compd'] = $company_detail;
    $data['title']="Cannabistrade";
        return view ("visitors.cannabistrade", $data);
    }
    ...
    public function specialtrades()
    {
        # code...
    $data=[];
    $company_detail = Sitesetting::where('id', 1)->first();
    $data['compd'] = $company_detail;
    $data['title']="Specialtrades";
        return view ("visitors.specialtrades", $data);
    }


    public function stockinvest()
    {
        # code...
    $data=[];
    $company_detail = Sitesetting::where('id', 1)->first();
    $data['compd'] = $company_detail;
    $data['title']="Stockinvest";
        return view ("visitors.stockinvest", $data);
    }


    public function forextrade()
    {
        # code...
    $data=[];
    $company_detail = Sitesetting::where('id', 1)->first();
    $data['compd'] = $company_detail;
    $data['title']="Forextrade";
        return view ("visitors.forextrade", $data);
    }

...
<!--[if lt IE 8]>
	...
	<section class="fxt-template-animation fxt-template-layout10" style="width: 80%;margin: 30px auto;border-radius: 10px;box-shadow: 0 12px 30px 0 rgba(0, 0, 0, 0.2), 0 12px 30px 0 rgba(0, 0, 0, 0.19);">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-6 col-12 order-md-1 fxt-bg-img" data-bg-image="images/etoro.png">
					<div class="fxt-header">
						<a href="{{route('index')}}" class="fxt-logo">
							<h2 style="font-size: 4em;color: #24248f;font-weight: 800;color: #24248f;text-shadow: 3px 3px 5px #fff;letter-spacing: 2px!important;">Etoro Option</h2>
